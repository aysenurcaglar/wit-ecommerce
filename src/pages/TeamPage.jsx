  ...
  return (
    <div className="bg-gray-50">
      ...
      >
        ...
        >
          <img
            src="https://placehold.co/600x400/lightcoral/white"
            alt="Image 1"
        ...
        >
          <img
            src="https://placehold.co/300x200/lightcoral/white"
            alt="Image 2"
            className="w-full h-full object-cover"
          />
        </div>
      ...
      <section className="text-center py-12 max-w-75vw mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-white rounded-lg pb-6 flex flex-col items-center"
            >
