  ...
  return (
    <section className="py-8 md:py-12 px-4 max-w-[85vw] md:max-w-75vw mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-6 gap-4">
        <div className="relative aspect-square md:aspect-auto md:col-span-2 md:row-span-6 h-full  hover:scale-105 cursor-pointer" onClick={handleCategoryClick}>
        ...
        <div className="relative aspect-square md:aspect-auto md:row-span-6 h-full hover:scale-105  cursor-pointer" onClick={handleCategoryClick}>
          <img src={editorsPickCategories[1].image} alt="Women" className="w-full h-full object-cover object-top" />
          <h3 className="absolute bottom-4 left-4 text-dark-gray text-base md:text-lg font-bold px-4 py-2 bg-white">
            WOMEN
          </h3>
        </div>
        <div className="relative aspect-square md:row-span-3 hover:scale-105  cursor-pointer" onClick={handleCategoryClick}>
