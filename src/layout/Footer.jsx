...
function Footer() {
  return (
    <footer className="py-8">
      <div className="container max-w-[85vw] md:max-w-75vw mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-y-6 md:gap-y-8 lg:gap-4 py-8 text-left">
          {/* Company Info */}
          <div>
            <h3 className="text-lg text-text-color font-bold">Company Info</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-lg text-text-color font-bold">Legal</h3>
            <ul className="mt-4 space-y-2 font-semibold text-light-gray">
          ...
          {/* Features */}
          <div>
            <h3 className="text-lg text-text-color font-bold">Features</h3>
            <ul className="mt-4 space-y-2 font-semibold text-light-gray">
          ...
          {/* Resources */}
          <div>
            <h3 className="text-lg text-text-color font-bold">Resources</h3>
            <ul className="mt-4 space-y-2 font-semibold text-light-gray">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-lg text-text-color font-bold">Get in Touch</h3>
            <div className="mt-4 flex flex-row">
              <Input placeholder="Your email" className="flex-2 md:w-auto" />
              <Button className="flex-1 md:w-auto p-2">Subscribe</Button>
            </div>
          </div>
        </div>
